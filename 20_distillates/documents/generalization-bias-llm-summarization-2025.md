...
- Human-authored NEJM Journal Watch summaries did not differ significantly from the original articles in their likelihood of containing generalized conclusions, while model summaries of the same articles were almost five times as likely to contain them as those human summaries (OR = 4.85, 95% CI [3.06, 7.70], p < 0.001). [[10_markdown/documents/generalization-bias-llm-summarization-2025#^pc37]] ^s7
- The material comprised 200 abstracts, 100 from the top four general medical journals and 100 from the top four multidisciplinary science journals. [[10_markdown/documents/generalization-bias-llm-summarization-2025#^pc39]] ^s8
