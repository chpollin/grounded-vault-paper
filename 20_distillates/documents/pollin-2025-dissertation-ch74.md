...
- The Promptotyping template printed in the chapter consists of the five sections Epics and User Stories, Domain Context, Data Model, Design Document and Implementation Instructions, each holding a placeholder for the project's own content. [[10_markdown/documents/pollin-2025-dissertation-ch74#^b5]] ^s5
