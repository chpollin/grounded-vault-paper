...
- Misgrounded responses are harder to detect than an outright fabricated case, because catching them requires the user to open the cited references, read and understand them, assess their authority and compare them with the propositions they are meant to support. [[10_markdown/documents/legal-ai-research-tools-hallucination-2025#^mg28]] ^s6
