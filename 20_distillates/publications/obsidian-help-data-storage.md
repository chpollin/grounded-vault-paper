...
- Obsidian uses IndexedDB, a low-level client-side database, as backend storage, where it maintains the state of Obsidian Sync connections and preserves the metadata cache while the application is closed. ^s6
