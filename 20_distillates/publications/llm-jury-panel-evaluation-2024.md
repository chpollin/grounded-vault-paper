...
- Overall the panel correlates most strongly with human judgment across the tasks compared, while GPT-4 is one of the weaker evaluators in that task setup. ^s5
