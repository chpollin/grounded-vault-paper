...
3. Mint a block ID on every anchor-relevant paragraph, set the H1 from the original, fill the metadata block per the template's `knowledge/schema.md`.
