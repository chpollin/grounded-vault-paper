...
- [[20_distillates/documents/liu-2023-evaluating-verifiability-generative-search-engines#^s2]] — supplies the measured share of citations that support their sentence, which puts a frequency on the class in deployed systems.
